...
class TikTokApi:
    ...
    def _initialize(self, logging_level=logging.WARNING, **kwargs):
        ...
        self._sid_tt = kwargs.get('sid_tt')
    ...
    def get_data(self, path, subdomain="m", **kwargs) -> dict:
        ...
        if kwargs.get('sid_tt') == None:
            if self._sid_tt != None:
                sid_tt = self._sid_tt
            else:
                sid_tt = 'ac56b1a2db48c4329b8268ee09c30bef'
        else:
            sid_tt = kwargs.get('sid_tt')
